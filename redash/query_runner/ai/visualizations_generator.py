...
VisualizationType = Enum("VisualizationType", {v.name.upper(): v.name.upper() for v in VisualizationInstanceType})
...
class VisualizationsGenerator:
    ...
    def get_visualization_titles(self, visualization) -> tuple[str, str]:
        ...
        titles = self.ai.prompt(
            ...
            [
                { "user": f"Given the following data: {self.data}, generate a title and description for a counter visualization.", "assistant": '{"name": "User Counter", "description": "Counts the number of users."}' },
            ]
        )
    ...
    def get_visualization(self, visualization, visualization_class) -> models.Visualization:
        ...
        return self.ai.prompt(
            ...
            [
                { "user": f"Given the following data: {self.data}, generate a counter visualization.", "assistant": '{"counterLabel": "User Count", "counterColName": "count", "countRow": false, "targetColName": "count"}' },
            ],
        )
